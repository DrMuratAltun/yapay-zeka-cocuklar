...
export const metadata: Metadata = {
  title: "Hakkında",
  description:
    "GençYZ projesi hakkında: Dr. Murat ALTUN tarafından ortaokul öğrencileri için hazırlanan uygulamalı yapay zeka eğitim platformu.",
  alternates: {
    canonical: "https://gencyz.com/hakkinda",
  },
};
