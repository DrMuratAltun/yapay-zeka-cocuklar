    ...
    <div className="min-h-screen">
      <header className="bg-gradient-to-r from-rose-500 to-pink-600 text-white">
        <div className="mx-auto max-w-4xl px-6 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-rose-200">BÖLÜM 8 &middot; 7-8. Sınıf &middot; 6 ders saati</p>
              <h1 className="text-3xl font-extrabold">Dijital İçerik Üretimi</h1>
              <p className="text-rose-200">YZ ile Yaratıcılık</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-4xl px-6 py-10 space-y-10">
        <section className="rounded-2xl border-l-4 border-rose-500 bg-rose-50 p-6 dark:bg-rose-900/20">
          <h2 className="mb-3 text-lg font-bold text-rose-700 dark:text-rose-300">Neler Öğreneceğiz?</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-extrabold">1. YZ ile Görüntü Üretme</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-extrabold">2. Görüntü Prompt Teknikleri</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-extrabold">3. Canva AI ile Tasarım</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-extrabold">4. Dijital Hikaye Anlatımı</h2>
        ...
        <div className="rounded-xl border-2 border-amber-300 bg-amber-50 p-5 dark:border-amber-700 dark:bg-amber-900/20">
          <h3 className="mb-2 font-bold text-amber-700 dark:text-amber-400">⚠️ Telif Hakkı ve Etik</h3>
        ...
        <section className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-6">
          ...
          <div className="space-y-3">
            {["Yapay mı Gerçek mi? Kart Seti (PDF)", "Dijital Hikaye Planlama Şablonu (PDF)", "Canva AI Hızlı Rehber (PDF)", "Değerlendirme Testi (PDF)", "Öz Değerlendirme Formu (PDF)"].map((d) => (
        ...
        <div className="flex items-center justify-between pt-6">
          <Link href="/bolumler/7" className="rounded-lg border border-[var(--color-border)] px-6 py-3 font-medium transition hover:bg-[var(--color-bg-secondary)]">&larr; Bölüm 7</Link>
          <Link href="/bolumler/9" className="rounded-lg bg-rose-600 px-6 py-3 font-medium text-white transition hover:bg-rose-700">Bölüm 9 &rarr;</Link>
        </div>
      </main>
    </div>
  );
