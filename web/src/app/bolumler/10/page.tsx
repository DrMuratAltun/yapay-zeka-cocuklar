    ...
    <div className="min-h-screen">
      <header className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
        <div className="mx-auto max-w-4xl px-6 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-indigo-200">BÖLÜM 10 &middot; 8. Sınıf &middot; 8 ders saati</p>
              <h1 className="text-3xl font-extrabold">Gelecek Seninle Başlar</h1>
      ...
      <main className="mx-auto max-w-4xl px-6 py-10 space-y-10">
        ...
        <div className="flex items-center justify-between pt-6">
          <Link href="/bolumler/9" className="rounded-lg border border-[var(--color-border)] px-6 py-3 font-medium transition hover:bg-[var(--color-bg-secondary)]">&larr; Bölüm 9</Link>
          <Link href="/" className="rounded-lg bg-indigo-600 px-6 py-3 font-medium text-white transition hover:bg-indigo-700">Ana Sayfaya Dön</Link>
        </div>
      </main>
    </div>
  );
