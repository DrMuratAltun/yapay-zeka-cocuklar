...
const bulmacalar: Bulmaca[] = [
  {
    ...
    mevcutBloklar: [
      ...
      { id: "b1_4", tip: "kosul", metin: "Eğer insan algılandıysa", renk: blokRenkleri.koşul, emoji: "❓" },
    ],
  ...
  },
  {
    ...
    mevcutBloklar: [
      ...
      { id: "b2_6", tip: "kosul", metin: "Değilse (üzgün ise)", renk: blokRenkleri.koşul, emoji: "😢" },
    ],
  ...
  },
  {
    ...
    zorluk: "Zor",
    mevcutBloklar: [
      { id: "b3_1", tip: "dongu", metin: "Sürekli tekrarla", renk: blokRenkleri.döngü, emoji: "🔄" },
      { id: "b3_2", tip: "eylem", metin: "\"Çok kalabalık!\" de", renk: blokRenkleri.eylem, emoji: "⚠️" },
      { id: "b3_3", tip: "degisken", metin: "sayaç = algılanan nesne sayısı", renk: blokRenkleri.değişken, emoji: "📊" },
      { id: "b3_4", tip: "olay", metin: "Yeşil bayrak tıklandığında", renk: blokRenkleri.olay, emoji: "🚩" },
      { id: "b3_5", tip: "kosul", metin: "Eğer sayaç > 5 ise", renk: blokRenkleri.koşul, emoji: "❓" },
      { id: "b3_6", tip: "yz", metin: "Kamerada nesne algıla", renk: blokRenkleri.yz, emoji: "🤖" },
      { id: "b3_7", tip: "eylem", metin: "sayaç değerini ekrana yaz", renk: blokRenkleri.eylem, emoji: "💬" },
    ],
