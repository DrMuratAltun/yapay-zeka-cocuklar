...
const kartlar: Kart[] = [
  ...
  { ad: "Netflix film önerisi", aciklama: "İzleme geçmişine göre sevebileceğin filmler önerir.", yzMi: true, neden: "Netflix, makine öğrenimi algoritmaları ile izleme alışkanlıklarını analiz eder ve kişiselleştirilmiş öneriler sunar." },
